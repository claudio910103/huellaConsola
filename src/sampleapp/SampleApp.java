...
public class SampleApp {
    private final static String DEFAULT_UI_FACTORY = "sampleapp.ConsoleUserInterfaceFactory";
    private final static String DEFAULT_DB_FACTORY = "sampleapp.SessionUserDatabaseFactory";
